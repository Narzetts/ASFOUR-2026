...
// Blok aksi admin hanya bisa diakses jika sudah login
if ($isLoggedIn) {
    $currentRole = $_SESSION['admin_role'];

    // Mengubah status buka/tutup survei (staff tidak bisa)
    ...
    // Hapus data survei (hanya super_admin)
    ...
    // Tambah admin baru (hanya super_admin)
    ...
    // Hapus admin lain (hanya super_admin, tidak bisa hapus diri sendiri)
...
<head>
    ...
    <style>
        /* Variabel CSS untuk tema dashboard admin */
        :root {
            --bg-primary: #FF8C00;
            --bg-secondary: #FFA500;
            --card-bg: #FFFFFF;
        ...
        * {
        ...
        /* Tampilan halaman login overlay */
        .login-overlay {
            position: fixed;
            inset: 0;
            background: linear-gradient(135deg, #FFD700 0%, #FF8C00 50%, #FF6347 100%);
        ...
        /* Link aksi seperti hapus dan edit */
        .action-link {
            color: var(--accent);
            text-decoration: none;
            font-weight: 500;
        ...
        /* Info pengguna di bagian bawah sidebar */
        .sidebar-user-info {
            margin-top: auto;
            padding-top: 20px;
        ...
        /* Header mobile dan tombol sidebar */
        .mobile-header {
                display: flex;
            }
        ...
        /* Header dashboard dengan judul dan badge status */
        .header {
                flex-direction: column;
...
<script>
    // Berpindah antar section/tab di dashboard
    ...
    // Membuka/menutup sidebar di tampilan mobile
    ...
    // Membuka modal pratinjau file (gambar, PDF, atau file lain)
    ...
    // Override showSection untuk memuat statistik AI setiap kali tab AI dibuka
    ...
    // Memuat statistik analisis AI dari server
    ...
    // Menampilkan grafik batang distribusi kategori menggunakan Chart.js
    ...
    // Menampilkan tabel hasil analisis terbaru
    ...
    // Mencegah XSS dengan meng-escape teks HTML
    ...
    // Menjalankan analisis AI untuk semua data survei yang belum dianalisis
