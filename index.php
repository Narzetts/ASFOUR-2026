...
// Jika survei ditutup, arahkan ke halaman "Belum Dimulai"
if (!isSurveyOpen($pdo)) {
...
<head>
    ...
    <style>
        /* Variabel CSS untuk tema warna dan ukuran */
        :root {
            --bg-primary: #FF8C00;
            --bg-secondary: #FFA500;
            --card-bg: #FFFFFF;
        ...
        * {
        ...
        /* Pembungkus konten agar tampil di tengah */
        .content-wrapper {
            text-align: center;
            width: 100%;
            max-width: 700px;
        ...
        /* Setiap section adalah halaman penuh yang bisa ditampilkan/diganti */
        section {
            width: 100%;
            min-height: 100vh;
            position: absolute;
        ...
        /* HALAMAN 4: Halaman Terima Kasih */
    ...
    <script>
        // Redirect ke halaman "Belum Dimulai" jika survei ditutup
...
<body>
    ...
    <script>
        ...
        // Fungsi untuk berpindah antar halaman (landing, loading, form, thanks)
        ...
        // Simulasi loading bar sebelum menampilkan form
        ...
        // Memutar musik latar (track 1 = lokal, track 2 = CDN)
        ...
        // Menampilkan dropdown angkatan hanya jika role = Siswa
        ...
        // Pratinjau file yang akan diupload sebelum dikirim
        ...
        // Mengirim form survei via AJAX ke submit_survey.php
